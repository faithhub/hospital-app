        ...
        <div class="card-body">
            ...
            <form id="add-image" enctype="multipart/form-data">
                <div class="modal-body edit-doc-profile">
                    <div class="row clearfix">
                        ...
                        <div class="col-lg-12 col-md-12 mb-3">
                            <b>Image</b>
                            <div class="input-group">
                                <input type="file" name="image" accept="" class="form-control" value="<?php if ($this->uri->segment(3) && isset($vital_details->image)) {
                                                                                                            echo $vital_details->image;
                                                                                                        } ?>">
                            </div>
                            <code style="color: #ff0000;font-size: 12px;" class="form-control-feedback" data-field="image"></code>
                        </div>
                        <div class="col-lg-12 col-md-12 mb-3">
                            <b>Description</b>
                            <div class="input-group">
                ...
                <div class="text-right">
                    <button type="button" class="btn btn-success" onclick="form_routes_image('add_image')" title="add_image">Save</button>
                </div>
            </form>
        </div>
    </div>
...
<?php $this->load->view('patient/new_image_script'); ?>