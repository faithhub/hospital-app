            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a> Pharmacy Request</h2>
                    </div>            
                </div>
            </div>
            ...
            <div class="row clearfix">
                <div class="col-md-12">
                    <div class="card patients-list">
                        ...
                        <div class="body">
                            <!-- Nav tabs -->
                            <button class="btn btn-primary m-b-15" type="button" data-toggle="modal" data-target="#pharmacyRequest" onclick="clear_textbox()">
                                ...
                                <div class="tab-pane table-responsive active show" id="All">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td><span class="badge badge-success"><a href="#" data-toggle="modal" data-target="#takeVitals">Cancel Request</a></span><span class="badge badge-success"><a href="#" data-toggle="modal" data-target="#takeVitals" onclick="clear_textbox()">View/Edit</a></span></td>
                                            </tr>
                                               <?php 
                                               $i++;
                                           } ?>
...
<?php $this->load->view('nursing/pharmacy-request-modal'); ?>
