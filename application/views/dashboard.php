                            ...
                            <ul class="list-unstyled">
                                <li>
                                    ...
                                    <div class="m-l-35 m-b-30">
                                        ...
                                        <ul class="list-unstyled team-info">
                                            <li><img src="<?php echo base_url(); ?>assets/images/xs/avatar1.jpg" data-toggle="tooltip" data-placement="top" title="Dr. Chris Fox" alt="Avatar"></li>
                                            <li><img src="<?php echo base_url(); ?>assets/images/xs/avatar2.jpg" data-toggle="tooltip" data-placement="top" title="Dr. Joge Lucky" alt="Avatar"></li>
                                            <li><img src="<?php echo base_url(); ?>assets/images/xs/avatar5.jpg" data-toggle="tooltip" data-placement="top" title="Isabella" alt="Avatar"></li>
                                        </ul>
                                    </div>
                                </li>
                                <li>
                                ...
                                <li>
                                    ...
                                    <div class="m-l-35">
                                        <small class="text-muted">SCHEDULED FOR 4:30 P.M. ON JUN 2018</small>
                                        <ul class="list-unstyled team-info">
                                            <li><img src="<?php echo base_url(); ?>assets/images/xs/avatar4.jpg" data-toggle="tooltip" data-placement="top" title="Dr. Chris Fox" alt="Avatar"></li>
                                            <li><img src="<?php echo base_url(); ?>assets/images/xs/avatar6.jpg" data-toggle="tooltip" data-placement="top" title="Dr. Joge Lucky" alt="Avatar"></li>
                                        </ul>
                                    </div>
                                </li>
                            </ul>
                                ...
                                <div class="body text-center">
                                    <div class="cwidget-scroll">
                                        <ul class="chat-widget m-r-5 clearfix">
                                            ...
                                            <li class="right">
                                                <img src="<?php echo base_url(); ?>assets/images/xs/avatar1.jpg" class="rounded-circle" alt="">
                                                <div class="chat-info">
                            ...
                            <div class="timeline-item blue">
                                ...
                                <div class="msg">
                                    ...
                                    <div class="timeline_img m-b-20">
                                        <img class="w-25" src="<?php echo base_url(); ?>assets/images/blog/blog-page-4.jpg" alt="Awesome Image">
                                        <img class="w-25" src="<?php echo base_url(); ?>assets/images/blog/blog-page-2.jpg" alt="Awesome Image">
                                    </div>
                                    <a href="javascript:void(0);" class="m-r-20"><i class="icon-heart"></i> Like</a>
                            ...
                            <div class="table-responsive table_middel">
                                <table class="table m-b-0">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>1</td>
                                            <td><img src="<?php echo base_url(); ?>assets/images/xs/avatar3.jpg" class="rounded-circle width30 m-r-15" alt="profile-image"><span>John</span></td>
                                        ...
                                        <tr>
                                            <td>2</td>
                                            <td><img src="<?php echo base_url(); ?>assets/images/xs/avatar1.jpg" class="rounded-circle width30 m-r-15" alt="profile-image"><span>Jack Bird</span></td>
                                        ...
                                        <tr>
                                            <td>3</td>
                                            <td><img src="<?php echo base_url(); ?>assets/images/xs/avatar4.jpg" class="rounded-circle width30 m-r-15" alt="profile-image"><span>Dean Otto</span></td>
                                            <td><span class="text-info">123 6th St. Melbourne, FL 32904</span></td>
                                            <td>Sept 13, 2017</td>
                                            <td>Sept 23, 2017</td>
                                            <td><span class="badge badge-warning">MEDIUM</span></td>
                                        ...
                                        <tr>
                                            <td>4</td>
                                            <td><img src="<?php echo base_url(); ?>assets/images/xs/avatar2.jpg" class="rounded-circle width30 m-r-15" alt="profile-image"><span>Jack Bird</span></td>
                                        ...
                                        <tr>
                                            <td>5</td>
                                            <td><img src="<?php echo base_url(); ?>assets/images/xs/avatar5.jpg" class="rounded-circle width30 m-r-15" alt="profile-image"><span>Hughe L.</span></td>
                                            <td><span class="text-info">4 Shirley Ave. West Chicago, IL 60185</span></td>
                                            <td>Sept 18, 2017</td>
                                            <td>Sept 18, 2017</td>
